...
// init sets up the test function pointer for the service layer
func init() {
	// Set the test function pointer to avoid circular dependency
	service.TestChannelModelFunc = func(channel *model.Channel, modelName string) bool {
		result := testChannel(channel, modelName, "")
