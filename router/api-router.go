...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.GET("/payment_info", controller.GetSubscriptionPaymentInfo)
			subscriptionRoute.GET("/self", controller.GetSubscriptionSelf)
			subscriptionRoute.POST("/redeem", controller.RedeemSubscriptionKey)
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionAdminRoute.POST("/keys", controller.AdminCreateSubscriptionKeys)
		...
		tokenRoute.Use(middleware.UserAuth())
		{
			...
			tokenRoute.POST("/:id/renew", controller.RenewSubscriptionToken)
			tokenRoute.POST("/:id/upgrade", controller.UpgradeSubscriptionToken)
			tokenRoute.DELETE("/:id/renewals/:index", controller.DeleteSubscriptionTokenRenewal)
		...
		{
			tokenAdminRoute.POST("/issue", controller.AdminIssueSubscriptionTokens)
		}
