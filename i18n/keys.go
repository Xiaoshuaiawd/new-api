...
const (
	...
	MsgRedemptionSubscriptionOnly  = "redemption.subscription_only"
	MsgRedemptionQuotaOnly         = "redemption.quota_only"
	MsgRedemptionPlanNotExists     = "redemption.plan_not_exists"
)
