...
// GetFileBase64FromUrlNoCache 从 URL 下载文件并转换为 Base64，不使用缓存
// 专门用于大文件（如视频）以避免内存占用
func GetFileBase64FromUrlNoCache(c *gin.Context, url string, reason ...string) (*types.LocalFileData, error) {
	var maxFileSize = constant.MaxFileDownloadMB * 1024 * 1024
