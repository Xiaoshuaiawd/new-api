                    ...
                    <>
                      ...
                      <div className='text-center'>
                        <div
                          ...
                          style={{ color: 'white' }}
                        >
                          {renderQuota(userState?.user?.permanent_quota - userState?.user?.permanent_quota_used)}
                        </div>
                      ...
                      <div className='text-center'>
                        <div
                          ...
                          style={{ color: 'white' }}
                        >
                          {renderQuota(userState?.user?.monthly_quota - userState?.user?.monthly_quota_used)}
                        </div>
                        <div className='flex items-center justify-center text-sm'>
                          <TrendingUp
                            size={14}
                      ...
                      <div className='text-center'>
                        <div
                          ...
                          style={{ color: 'white' }}
                        >
                          {renderQuota(userState?.user?.daily_quota - userState?.user?.daily_quota_used)}
                        </div>
                        <div className='flex items-center justify-center text-sm'>
                          <BarChart2
                            size={14}
                    ...
                    <>
                      ...
                      <div className='text-center'>
                        <div
                          ...
                          style={{ color: 'white' }}
                        >
                          {renderQuota(userState?.user?.quota - userState?.user?.used_quota)}
                        </div>
                        <div className='flex items-center justify-center text-sm'>
                          <Wallet
                            size={14}
                ...
                {userState?.user?.has_subscription && (
                  <div className='mt-4 pt-4 border-t border-white/20'>
                    <div className='text-center'>
                      ...
                      >
                        📦 {userState?.user?.package_name || t('套餐用户')}
                      </Text>
                      <div className='text-xs mt-1' style={{ color: 'rgba(255,255,255,0.7)' }}>
                        {t('总请求次数')}: {userState?.user?.request_count || 0}
                      </div>
                    </div>
                  </div>
                )}
